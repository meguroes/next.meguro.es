...
export const WANTED_SPONSOR_DESCRIPTION = [
  ...
  "・運営のために必要な消耗品の購入資金",
  "<br>",
  "スポンサープランにはこれらのものがございます。",
  "・さくら：「パンフレットやノベルティの配布」「ロゴ・社名の掲載や紹介」「会社・団体・サービス紹介の時間の確保」",
  "・さんま：「パンフレットやノベルティの配布」「ロゴ・社名の掲載や紹介」",
  "・たけのこ：「会社・団体・サービス紹介の時間の確保」",
  "<br>",
...
export const WANTED_SPONSOR_REWARD: Paragraph[] = [
  {
    ...
    description: [
      "イベント会場内でパンフレットやノベルティなどの配布を最大3点まで行うことができます。",
    ],
  },
  {
    id: "02",
    title: "ロゴ・社名の掲載や紹介",
    description: [
      "当サイトやconnpassページ、イベント中のスライドへの社名やロゴの掲載と、イベント冒頭での社名読み上げがございます。",
    ],
  },
  {
    id: "03",
    ...
    description: [
      "イベント中のスライドに、会社・団体・サービス紹介のスライドを最大3枚まで掲載できます。",
    ],
  },
];
